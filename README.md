...
- **macOS** - stable 0.0.42 for Apple Silicon, plus a nightly track
- **Windows** - stable 0.0.42 for x64, plus a nightly track; free core app only, with no Pro support yet
