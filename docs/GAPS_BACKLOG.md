...
- **Platform availability was not represented consistently across the main customer journey** (resolved 2026-07-17; refreshed 2026-09-25). Home, Download, Desktop, Desktop Releases, Mobile, Mobile Releases, analytics metadata, site metadata, and `llms.txt` now present iOS, Android, macOS, and Windows. The copy distinguishes stable releases from the optional nightly tracks and records macOS and Windows x64 stable `v0.0.51`; Windows remains the free core app without Pro support. Verified the non-prerelease `v0.0.51` GitHub release, its permanent macOS and Windows installers, and the permanent Windows nightly installer; each installer URL redirects to a live release asset.
