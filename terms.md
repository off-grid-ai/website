...
These Terms of Service ("Terms") are a legal agreement between you and Wednesday Solutions ("Off Grid AI", "we", "us", or "our") covering the OGAD (Off Grid AI Desktop) and OGAM (Off Grid AI Mobile) applications, the OGAC (Off Grid AI Console), the `@offgrid/*` software, our websites, and any related services (together, the "Service").
