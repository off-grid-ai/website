...
**What does Pro cost?** ${{ site.data.pricing.price }}/{{ site.data.pricing.period }} today, climbing toward ${{ site.data.pricing.top_price }}/{{ site.data.pricing.period }} as we grow — the tier you join at is the rate you hold. Prefer to own it? ${{ site.data.pricing.price | times: site.data.pricing.lifetime_multiplier }} once, lifetime (that's {{ site.data.pricing.lifetime_multiplier }} years, then yours forever). One license covers {{ site.data.pricing.devices }} devices.
